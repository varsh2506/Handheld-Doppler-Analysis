...
public class WavFile
{
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            {
                WavFile readWavFile = openWavFile(new File("C:\\Users\\admin\\Desktop\\WavFile\\cw_adiveppa_4_19.wav"));
                readWavFile.display();
...
//				long[] buffer = new long[BUF_SIZE * numChannels];
            ...
            WavFile writeWavFile = newWavFile(new File("out.wav"), 1, 10, 23, 44100);
