package com.dimowner.audiorecorder.debug.stats;
...
public class Autocorrelation {
    ...
    private double[] formatData(double[] metrics) {
        int n = metrics.length;
    ...
    public double[] evaluate(double[] metrics) {
        double[] values = formatData(metrics);
        // FFT
    ...
    public List<Integer> findPeaks(double[] correlations) {
